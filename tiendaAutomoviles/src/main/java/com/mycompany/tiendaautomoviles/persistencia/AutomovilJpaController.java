...
public class AutomovilJpaController implements Serializable {
    ...
    */
    ...
    private static AutomovilJpaController autoJpa= null;
    private EntityManagerFactory emf = null;

    private AutomovilJpaController() {
        emf = Persistence.createEntityManagerFactory("TiendaAutoPU");
    }
    
    public static AutomovilJpaController getInstance() {
        if(autoJpa == null){
            return (autoJpa = new AutomovilJpaController());
        } return AutomovilJpaController.autoJpa;
    }
